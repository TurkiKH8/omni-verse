...
const DEFAULT = "We respect your privacy. Your personal data is never sold to third parties. We only collect what is necessary to run the platform and keep your account secure.";
      ...
      <main className="flex-1 px-6 py-16 relative z-10">
        <div className="max-w-3xl mx-auto flex flex-col gap-8">
          <div className="text-center">
            <h1 className="text-4xl font-extrabold" style={{ color: "#e8d5a0" }}>Privacy Policy</h1>
